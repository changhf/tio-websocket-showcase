 ...
 * @author chang_hfeng
 */
public class DeliIpStatListener implements IpStatListener {
    @SuppressWarnings("unused")
    private static Logger log = LoggerFactory.getLogger(DeliIpStatListener.class);

    public static final DeliIpStatListener me = new DeliIpStatListener();

    /**
     *
     */
    private DeliIpStatListener() {
    }
