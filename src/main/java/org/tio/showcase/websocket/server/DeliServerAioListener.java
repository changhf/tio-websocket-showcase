 ...
 * @author chang_hfeng
 */
public class DeliServerAioListener extends WsServerAioListener {
    private static Logger log = LoggerFactory.getLogger(DeliServerAioListener.class);

    public static final DeliServerAioListener me = new DeliServerAioListener();

    private DeliServerAioListener() {
    ...
    public void onBeforeClose(ChannelContext channelContext, Throwable throwable, String remark, boolean isRemove) throws Exception {
        ...
        if (wsSessionContext != null && wsSessionContext.isHandshaked()) {
            ...
            WsResponse wsResponse = WsResponse.fromText(msg, DeliServerConfig.CHARSET);
            //群发
