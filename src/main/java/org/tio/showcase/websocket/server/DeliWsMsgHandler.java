 ...
 * @author chang_hfeng
 */
public class DeliWsMsgHandler implements IWsMsgHandler {
    private static Logger log = LoggerFactory.getLogger(DeliWsMsgHandler.class);

    public static final DeliWsMsgHandler me = new DeliWsMsgHandler();

    private DeliWsMsgHandler() {
